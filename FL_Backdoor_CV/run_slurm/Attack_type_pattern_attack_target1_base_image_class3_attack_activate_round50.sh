...
srun -N 1 -n 1  --nodelist=atlas --gres=gpu:1 python FL_Backdoor.py --dataset cifar10 --model res --attack_epoch 50 --weights_scale 1 --lr 0.1 --bs 32 --cp 16 --master_port 10752 --attacker_user_id 10 --num_comm_ue 10 --attack_activate_round 50 --NIID 1 --rank 0 --size 200 --warmup_epoch 0 --NDC 1 --master_node atlas --epoch 400 --experiment_name Cifar10_UE200_comUE10_NIID1_res_attack_typepattern_attack_target1_base_image_class3_attack_activate_round50_fine_tuning_start_round300_total_epoches400 --attack_target 1 --fine_tuning_start_round 300 --attack_type pattern --iteration 17 --base_image_class 3 --one_shot_attack 1 >./logs/Rank0_attack_target1.log 2>./logs/Rank0_attack_target1.err & 
...
## This script run Cifar10_UE200_comUE10_NIID1_res_attack_typepattern_attack_target1_base_image_class3_attack_activate_round50_fine_tuning_start_round300_total_epoches400
