...
def ResNet18_gn():
    return ResNet_gn(BasicBlock, [2,2,2,2])

def ResNet34_gn():
    return ResNet_gn(BasicBlock, [3,4,6,3])

def ResNet50_gn():
    return ResNet_gn(Bottleneck, [3,4,6,3])

def ResNet101_gn():
    return ResNet_gn(Bottleneck, [3,4,23,3])

def ResNet152_gn():
    return ResNet_gn(Bottleneck, [3,8,36,3])
